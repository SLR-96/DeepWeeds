...
x = Conv2D(64, 2, activation='relu', padding='same', strides=2)(myinput)
x = Dropout(0.2)(x)
x = Conv2D(64, 2, activation='relu', padding='same', strides=2)(x)
x = Dropout(0.2)(x)
...
x = Conv2D(256, 2, activation='relu', padding='same', strides=2)(x)
x = Dropout(0.2)(x)
x = Conv2D(512, 2, activation='relu', padding='same', strides=2)(x)
x = Dropout(0.2)(x)
x = Conv2D(512, 2, activation='relu', padding='same', strides=2)(x)
x = Dropout(0.2)(x)
